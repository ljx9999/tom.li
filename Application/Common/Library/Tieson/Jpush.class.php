...
class Jpush{
        private $app_key = '354177df8c5cecab824ce9f3';     //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = '69fe7f75b89d91261513ae15';    //主密码
        ...
        **/
        ...
        public function send_pub($receive,$content,$m_type,$m_txt,$m_time){
            ...
            $m_txt = 'http://www.baidu.com/';//推送附加字段的类型对应的内容(可不填) 可能是url,可能是一段文字。
            $m_time = '86400';//离线保留时间
