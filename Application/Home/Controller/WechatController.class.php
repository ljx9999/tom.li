...
class WechatController extends Controller{
    ...
    {
        $app_secret = '632148c8c02a022a0d3e1a51d756bf01';
        $app_id = 'wxde4b531350ffb90b';
        ...
        $json = httpController::http($token_url);
        $wtb_man_info['openid']     = $json->openid;
        $wtb_man_info['access_token']   = $json->access_token;
        return json_encode($wtb_man_info);
    ...
    public function get_user_info($access_token = '', $open_id = '')
    {
        ...
        if($access_token && $open_id)
        {
            ...
            $info_data = httpController::http($info_url);
   ...
   public function httpUrl($url, $method, $postfields = null, $headers = array(), $debug = false)
    {
        $ci = curl_init();
        /* Curl settings */
