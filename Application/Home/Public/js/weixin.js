	...
	if (!a.jWeixin) return q = {
		...
		playMusic: function(a) {
			c(q.playMusic, {
				...
				singer: a.singer,
				epname: a.epName,
				coverImgUrl: a.imgUrl,
				dataUrl: a.dataUrl,
				lowbandUrl: a.lowbandUrl || a.dataUrl,
				webUrl: a.link
			}, a)
		},
		...
		getLatestAddress: function(a) {
			c("getLatestAddress", f(a, "jsapi_address"), function() {
				return a._complete = function(a) {
					a = h(a)
				}, a
			}())
		...
		editAddress: function(a) {
			c("editAddress", f(a, "jsapi_address"), function() {
				return a._complete = function(a) {
					a = h(a)
				}, a
			}())
		...
		addCard: function(a) {
			var e, f, g, h, b = a.cardList,
				d = [];
			for (e = 0, f = b.length; f > e; ++e) g = b[e], h = {}, h.card_id = g.cardId, h.card_ext = g.cardExt, d.push(h);
			c(q.addCard, {
				card_list: d
			}, function() {
				return a._complete = function(a) {
