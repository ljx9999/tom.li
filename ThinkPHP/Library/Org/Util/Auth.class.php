...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP' => 'mbiz_auth_group', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 'mbiz_auth_group_access', //用户组明细表
        'AUTH_RULE' => 'mbiz_auth_rule', //权限规则表
        'AUTH_USER' => 'mbiz_admin_user'//用户信息表
    );
    ...
    public function checkOld($name, $uid, $relation='or') {
